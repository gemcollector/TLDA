...
def parse_args():
	...
	parser.add_argument('--lamba', default=1, type=int)
	parser.add_argument('--width', default=7, type=int)
	parser.add_argument('--mean', default=13, type=int)
	parser.add_argument('--std', default=3, type=int)
	...
	assert args.algorithm in {'tlda', 'drq', 'sac'}, f'specified algorithm "{args.algorithm}" is not supported'
